...
- Learn how to implement texture sets and create a plugin so the recolours I have already made can be crafted in game
- Personal recolour of Iron Mercenary Light Armor
- A simple armor mashup with plugin so it can be crafted in game


### Tutorials not linked to in invidual entries but are extremely helpful
[All the Outfit Studio tutorials by Mom's Gaming Channel](https://youtu.be/G60bEvHxi_Q)

### Day 1
I managed to get the plugin created and I can craft the recoloured dresses in game, but the new texture isn't showing up so clearly I have something pathed wrong somewhere. 
...
I also tidied up the plugin so all my dress colours are now working in third person.  None of them are working in first person yet, but I never play first person so I don't really care.  
